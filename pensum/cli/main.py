...
Subcommands:
  ...
  validate   - run pensum.validate() on a Python schema module (no network calls)
"""
...
from pensum.cli import (  # noqa: F401 — side-effect: registers @app.command
    cmd_reflect,
    cmd_revision,
    cmd_stamp,
    cmd_upgrade,
...
from pensum.cli.app import main
