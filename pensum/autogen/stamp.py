"""Brownfield: bring existing Jira objects under pensum management.
...
`pensum revision --autogenerate` calls can diff against.
...
def _stamp_projects(state, snapshot, desired, report) -> None:
    ...
    for alias, want in desired.projects.items():
        ...
        # "next-gen" (TMP) on Cloud. Normalize to pensum's vocabulary.
